    ...
    <header className="bg-gradient-to-r from-primary to-secondary text-white px-3 md:px-6 py-3 md:py-4 shadow-lg relative z-[1000]">
      ...
      <div className="hidden lg:flex items-center justify-between">
        <div className="flex-shrink-0">
          <h1 className="text-2xl font-bold tracking-wider whitespace-nowrap">唐诗三百首 · 地名地图</h1>
      ...
      {/* Tablet layout - for medium screens (768-1024px) */}
      <div className="hidden md:block lg:hidden">
        <div className="flex items-center justify-between mb-3">
          <div className="flex-shrink-0">
            <h1 className="text-xl font-bold tracking-wider whitespace-nowrap">唐诗三百首 · 地名地图</h1>
          </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative flex-shrink-0">
            <input
              ...
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              className="w-40 px-4 py-1.5 pl-9 rounded-full bg-white/20 backdrop-blur text-white placeholder-white/60 outline-none focus:bg-white/30 transition text-sm"
            />
            <svg
